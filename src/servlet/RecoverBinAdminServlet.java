...
/**
 * Servlet implementation class RecoverBinAdminServlet
 */
@WebServlet("/RecoverBinAdminServlet")
public class RecoverBinAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//将user表中的数据删除，将数据添加到回收站表，取反
